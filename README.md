...
1. Install and enable the extension either through the official LNbits manifest or by adding https://raw.githubusercontent.com/lnbits/dca_admin/main/manifest.json to `"Server"/"Server"/"Extension Sources"`. ![Extension Sources](https://i.imgur.com/MUGwAU3.png) ![image](https://github.com/lnbits/dca_admin/assets/33088785/4133123b-c747-4458-ba6c-5cc7c0f124d8)

2. `Ctrl c` shut down your LNbits installation.
3. Download the extension files from https://github.com/lnbits/dca_admin to a folder outside of `/lnbits`, and initialize the folder with `git`. Alternatively, create a repo, copy the dca_admin extension files into it, then `git clone` the extension to a location outside of `/lnbits`.
...
7. When you're ready to share your manifest so others can install it, edit `/lnbits/dca_admin/manifest.json` to include the git credentials of your extension.
